<?php include('header.php') ?>
            ...
            <div class="about-booking-item book-info">
              <div class="book-info-item price">
                <div class="price-main">
                  <span class="price-main-item price-start"
                    >price starts as</span
                  >
                  <span class="price-main-item price-cost">$ 8,500</span>
                  <span class="price-main-item price-end"
                    >per room / night</span
                  >
                </div>
                <!-- /.price-main -->
              ...
              <button class="button book-info-item button-book-info">
                View Other Options
              </button>
            </div>
            <!-- /.about-booking-item -->
      ...
      <div class="wrapper">
        ...
        <div class="packages-card-container">
          <div class="packages-card hotel-haven">
            <button class="button hotel-advt card-hotel-advt">
              Flash Offer
            </button>
            <img
        ...
        <div class="wrapper newsletter-container">
          ...
          <form action="send.php" method="POST" class="newsletter-form">
            <input
              ...
              id="newsletter-input"
            />
            <button class="button newsletter-button" type="submit" value="subscribe" name="action">Send</button>
          </form>
        </div>
        <!-- /.wrapper -->
      </div>
    ...
    <section class="reviews">
      <div class="wrapper">
        <h2 class="reviews-item reviews-title">
            ...
            <div class="swiper-slide">
              <div class="reviews-slider-item">
                <div class="user-profile">
                  ...
                  <span class="user-profile-visitdate"
            ...
            <div class="swiper-slide">
              <div class="reviews-slider-item">
                ...
                <p class="user-review">
                  ...
                  Officiis non excepturi dolore error odio laudantium odit sequi
                  beatae assumenda exercitationem! Adipisci maiores labore nam
                  incidunt, molestiae sunt iste assumenda quae? Lorem ipsum
                  dolor sit amet consectetur adipisicing elit. Aut
                  necessitatibus maiores commodi qui natus repellat distinctio
                  sunt perspiciatis enim possimus cum, nemo modi placeat hic
                  dignissimos cupiditate animi explicabo unde?
                </p>
              </div>
              <!-- /.reviews-slider-item -->
            </div>
