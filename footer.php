        ...
        <div class="footer-card-container">
          ...
          <div class="footer-container-item contacts">
            ...
            <div class="contacts-details">
              <div class="contacts-details-item contacts-location">
                <img
              ...
              <!-- /.contacts-details-item contact-location -->
              <div class="contacts-details-item contacts-phone">
                <img
                  src="./img/contact-phone.svg"
                  alt="Contacts Icon: Phone"
                  class="contacts-icon"
                />
              ...
              <!-- /.contacts-details-item contact-phone -->
              <div class="contacts-details-item contacts-email">
                <img
                  src="./img/contact-email.svg"
                  alt="Contacts Icon: E-mail"
                  class="contacts-icon"
                />
                <a
              ...
              <!-- /.contacts-details-item contact-email -->
            </div>
            <!-- /.contacts-details -->
          </div>
          ...
          <div class="footer-container-item info-features">
            <img src="./img/features.svg" alt="Features" class="features-pic" />
          </div>
